...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', config('app.name', 'Lucerna Kabgayi Hôtel')); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'A sanctuary rooted in Catholic hospitality in the heart of Rwanda.'); ?>">
    <meta name="keywords"    content="<?php echo $__env->yieldContent('meta_keywords',   'Lucerna Kabgayi Hotel, Rwanda hotel, Muhanga hotel, Catholic hospitality'); ?>">
    ...
    <meta property="og:image"       content="<?php echo $__env->yieldContent('og_image', asset('frontend/assets/img/home-one.jpg')); ?>">
    <meta property="og:url"         content="<?php echo e(url()->current()); ?>">

    <script type="application/ld+json">
    {"@context":"https://schema.org","@type":"Hotel","name":"Lucerna Kabgayi Hôtel","url":"<?php echo e(url('/')); ?>","image":"<?php echo e(asset('frontend/assets/img/home-one.jpg')); ?>","address":{"@type":"PostalAddress","addressLocality":"Muhanga","addressRegion":"Southern Province","addressCountry":"RW"},"starRating":{"@type":"Rating","ratingValue":"3"}}
    </script>

    <?php $siteSetting = \App\Models\SiteSetting::first(); ?>
    <?php if(!empty($siteSetting->google_analytics_id)): ?>
    <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo e($siteSetting->google_analytics_id); ?>"></script>
    <script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','<?php echo e($siteSetting->google_analytics_id); ?>');</script>
    <?php endif; ?>
    ...
    <link rel="preload" as="image"  href="<?php echo e(asset('frontend/assets/img/home-one.jpg')); ?>" fetchpriority="high">
    <link rel="preload" as="image"  href="<?php echo e(asset('logo.png')); ?>">
    ...
    <style>
        ...
        *,*::before,*::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        @media(max-width:960px){
            .footer-cta-strip { flex-direction:column; text-align:center; gap:12px; }
            .footer-cta-text { font-size:16px; }
            .top-bar { padding:0 20px; font-size:11px; }
        }
        @media(max-width:768px){
            ...
            .nav-links { position:fixed; top:0; right:-100%; width:260px; height:100vh; background:var(--navy); flex-direction:column; padding:68px 22px 22px; gap:0; transition:right .4s var(--ease); box-shadow:-6px 0 24px rgba(0,0,0,.2); z-index:600; }
            .nav-links.open { right:0; }
            .nav-links.open::before { content:''; position:fixed; inset:0; width:100vw; background:rgba(0,0,0,.4); z-index:-1; }
            ...
            .top-bar.hidden + nav#mainNav { top:0; }
...
<div id="page-loader">
    <img src="<?php echo e(asset('logo.png')); ?>" alt="Lucerna" class="loader-logo">
...
<div class="top-bar" id="topBar">
    ...
    <div class="top-bar-center">
        <a href="<?php echo e(route('home')); ?>" class="tb-logo-link">
            <img src="<?php echo e(asset('logo.png')); ?>" alt="Lucerna Kabgayi Hôtel" class="tb-logo-img">
    ...
    <div class="top-bar-right">
            ...
            <div class="user-dropdown-wrap" id="userDropdown">
                <a href="javascript:void(0)" class="nav-auth nav-auth-user user-dropdown-toggle" id="userDropdownToggle">
                    <?php if(Auth::user()->photo): ?>
                        <img src="<?php echo e(asset(Auth::user()->photo)); ?>" alt="<?php echo e(Auth::user()->name); ?>">
                    <?php else: ?>
                ...
                <div class="user-dropdown">
                    <div class="ud-header">
                        <div class="ud-header-name"><?php echo e(Auth::user()->name); ?></div>
                        <div class="ud-header-email"><?php echo e(Auth::user()->email); ?></div>
                    </div>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="ud-link">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
                        Dashboard
                    </a>
                    <a href="<?php echo e(route('user.profile')); ?>" class="ud-link">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                        My Profile
                    </a>
                    <a href="<?php echo e(route('user.booking')); ?>" class="ud-link">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                        My Bookings
                    </a>
                    <a href="<?php echo e(route('user.change.password')); ?>" class="ud-link">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
                        Change Password
                    </a>
                    <div class="ud-sep"></div>
                    <form method="POST" action="<?php echo e(route('logout')); ?>" id="topBarLogoutForm">
                        <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" class="nav-auth">
            ...
            <a href="<?php echo e(route('register')); ?>" class="nav-join">Join</a>
        <?php endif; ?>
        <div class="tb-right-sep"></div>
        <a href="<?php echo e(route('home')); ?>#booking" class="nav-cta">Book Now</a>
    </div>
</div>
...
<nav id="mainNav">
    <ul class="nav-links" id="navLinks">
        ...
        <li><a href="<?php echo e(route('home')); ?>#dining">Dining</a></li>
        <li><a href="<?php echo e(route('home')); ?>#meetings">Events</a></li>
        ...
        <li class="mobile-auth" style="display:none;">
            ...
            <?php else: ?>
                ...
                <a href="<?php echo e(route('register')); ?>">Join / Register</a>
            <?php endif; ?>
        </li>
    </ul>
...
<footer>
    <div class="footer-cta-strip">
        ...
        <a href="<?php echo e(route('home')); ?>#booking" class="btn-blue" style="background:var(--navy-deep);flex-shrink:0;">
            <span>Book Now</span>
    ...
    <div class="footer-main">
        <div class="footer-brand">
            ...
            <div class="footer-social">
                <?php if(!empty($siteSetting->facebook)): ?>
                <a href="<?php echo e($siteSetting->facebook); ?>" aria-label="Facebook" target="_blank" rel="noopener">f</a>
                <?php endif; ?>
                <?php if(!empty($siteSetting->instagram)): ?>
                <a href="<?php echo e($siteSetting->instagram); ?>" aria-label="Instagram" target="_blank" rel="noopener">in</a>
                <?php endif; ?>
                <?php if(!empty($siteSetting->twitter)): ?>
                <a href="<?php echo e($siteSetting->twitter); ?>" aria-label="Twitter" target="_blank" rel="noopener">tw</a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="footer-col">
            ...
            <ul>
                <li><a href="<?php echo e(route('home')); ?>#amenities">Outdoor Garden</a></li>
                <li><a href="<?php echo e(route('home')); ?>#amenities">Fresh Linen Provided</a></li>
                <li><a href="<?php echo e(route('home')); ?>#amenities">Business Center</a></li>
                <li><a href="<?php echo e(route('home')); ?>#amenities">Meeting Space</a></li>
                <li><a href="<?php echo e(route('home')); ?>#amenities">Restaurant &amp; Bar</a></li>
                <li><a href="<?php echo e(route('home')); ?>#amenities">Fitness Center</a></li>
                <li><a href="<?php echo e(route('home')); ?>#amenities">On-Site Laundry</a></li>
                <li><a href="<?php echo e(route('home')); ?>#amenities">24-Hour Front Desk</a></li>
            </ul>
        </div>
        <div class="footer-col">
            ...
            <div class="footer-contact-item">
                ...
                <div><div class="footer-contact-label">Address</div><div class="footer-contact-val"><?php echo e($siteSetting->address ?? 'Muhanga, Kabgayi, Rwanda'); ?></div></div>
            </div>
            <div class="footer-contact-item">
                <span class="footer-contact-icon">◎</span>
                <div><div class="footer-contact-label">Phone</div><a class="footer-contact-val" href="tel:<?php echo e(preg_replace('/\s+/', '', $siteSetting->phone ?? '+250794191115')); ?>"><?php echo e($siteSetting->phone ?? '+250 794 191 115'); ?></a></div>
            </div>
            <div class="footer-contact-item">
                <span class="footer-contact-icon">✉</span>
                <div><div class="footer-contact-label">Email</div><a class="footer-contact-val" href="mailto:<?php echo e($siteSetting->email ?? 'hotellucernakabgayi@gmail.com'); ?>"><?php echo e($siteSetting->email ?? 'hotellucernakabgayi@gmail.com'); ?></a></div>
            </div>
        </div>
    </div>
    <div class="footer-bar">
        <div class="footer-copy">&copy; <?php echo e(date('Y')); ?> Lucerna Kabgayi Hôtel. All rights reserved.</div>
...
(function(){
    ...
    if(tog) tog.addEventListener('click',function(){ lnk.classList.toggle('open'); document.body.classList.toggle('nav-open'); });
    document.addEventListener('click',function(e){ if(lnk && lnk.classList.contains('open') && !lnk.contains(e.target) && e.target!==tog && !tog.contains(e.target)){ lnk.classList.remove('open'); document.body.classList.remove('nav-open'); } });
    /* User dropdown */
...
<script>(function(){ var t="<?php echo e(Session::get('alert-type','info')); ?>",m="<?php echo e(Session::get('message')); ?>",map={info:'info',success:'success',warning:'warning',error:'error'}; if(toastr[map[t]]) toastr[map[t]](m); })();</script>
<?php endif; ?>

<?php if(!empty($siteSetting->whatsapp)): ?>
<a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/','', $siteSetting->whatsapp)); ?>?text=<?php echo e(urlencode('Hello! I would like to make a reservation at Lucerna Kabgayi Hotel.')); ?>"
...
</html><?php /**PATH D:\workspace\htdocs\lucerna\resources\views/frontend/main_master.blade.php ENDPATH**/ ?>