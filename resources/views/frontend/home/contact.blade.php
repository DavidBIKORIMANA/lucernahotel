                    ...
                    <div class="contact-item">
                        <ul>
                            ...
                            <li>
                                <i class='bx bx-envelope'></i>
                                <div class="content">
                                    <span><a href="https://api.whatsapp.com/send?phone=+250794191115&text=Welcome,How can we Help you" target="_blank"><i class='bx bxl-whatsapp' style="color: green;"></i>+250794191115</a></span>
                                    <!-- <span><a href="{{ $setting->email }}">{{ $setting->email }}</a></span> -->
                                </div>
                            </li>
                        </ul>
