<div class="blog-area pt-20 pb-10">
    <div class="container">
            ...
            <div class="col-lg-6">
                <div class="book-content-two">
                    <div class="section-title">
                        ...
                        <h2 class="sp-color">Presidential suite</h2>
                        <h2 class="">We Are the Best in All-time & So Please Get a Quick Booking</h2>
                        <p>
                    ...
                    <a href="{{ route('booking.search.all') }}" class="default-btn btn-bg-three">Quick Booking</a>
                </div>
            </div>
