                      ...
                      <div class="row g-0">
                        ...
                        <div class="col-md-3">
                          <div class="card-body">
                            <h5 class="card-title">Room Name</h5>
                                ...
                                <p class="card-text"><small class="badge bg-primary">{{ $roomdetails->type->name }}</small></p>
                            </div>
                        </div>
                        <div class="col-md-3">
                          <div class="card-body">
                            <h5 class="card-title">Price</h5>
                                ...
                                <p class="card-text"><small class="badge bg-primary">$ {{ $roomdetails->price }}/Night/Room</small></p>
                        ...
                        <div class="col-md-2">
                          <div class="card-body">
                            ...
                            <p class="card-text"><small class="badge bg-warning text-dark"><b></b> {{ $roomdetails->room_capacity }} Person</small></p>
                        ...
                        <!-- <div class="col-md-2">
                          <div class="card-body">
                            ...
                            <p class="card-text"><small class="badge bg-success"><b>View : </b> {{ $roomdetails->view }}</small></p>

                          </div>
                        </div> -->
                        <div class="col-md-2">
                          <div class="card-body">
                            <h5 class="card-title">Bed Style</h5>

                            <p class="card-text"><small class="badge bg-info text-dark"><b></b> {{ $roomdetails->bed_style }}</small></p>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 col-md-8 p-0">
                            <div class="room-card-content">
                                ...
                                <a href="{{ route('search_room_details',$item->id.'?check_in='.old('check_in').'&check_out='.old('check_out').'&persion='.old('persion'))}}" class="book-more-btn">
                                Book Now
                                </a>
                            </div>
                        </div>
