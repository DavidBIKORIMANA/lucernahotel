                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a href="/">
                                <img src="{{ asset('frontend/assets/img/logos/logo.jpeg') }}" alt="Lucerna Kabgayi Hôtel">
                            </a>
                        </div>
                        <!-- <p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="social-icon text-align2">
                        <ul class="social-link">
                            ...
                            <!-- <li>
                                <a href="https://api.whatsapp.com/send?phone=+250794191115&text=Hello this is the starting message" target="_blank"><i class='bx bxl-whatsapp'></i></a>
                            </li> -->
                            <li>
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="copy-right-text text-align1">
                      <center>
                        <p>
                            {{ $setting->copyright??'' }}, {{ config('app.client_name') }}
                        </p>
                        </center>
                    </div>
                </div>
