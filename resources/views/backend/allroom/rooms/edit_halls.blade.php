                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form class="row g-3" action="{{ route('update.room',$editData->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-4">
                                    <label for="input1" class="form-label">Hall Name </label>
                                ...
                                <div class="col-md-4">
                                    <label for="input1" class="form-label">Hall Price   </label>
                                ...
                                <div class="col-md-4">
                                    <label for="input7" class="form-label">Hall Package </label>
                                ...
                                <div class="col-md-4">
                                       ...
                                       <div class="basic_facility_section_remove" id="basic_facility_section_remove">
                                                <div class="row add_item">
                                                    <div class="col-md-6">
                                                        <label for="basic_facility_name" class="form-label">Hall Facilities </label>
