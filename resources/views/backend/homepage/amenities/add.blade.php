...
<div class="page-content">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add Amenity</div>
        <div class="ps-3">
                        ...
                        <form action="{{ route('amenity.store') }}" method="post">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="icon" class="form-control" required placeholder="e.g. lni lni-dinner">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3"><h6 class="mb-0">Name *</h6></div>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control" required placeholder="Amenity name">
                                    </div>
                                </div>
                                <div class="row mb-3">
