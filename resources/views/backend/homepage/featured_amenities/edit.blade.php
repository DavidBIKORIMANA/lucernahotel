...
<div class="page-content">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Edit Featured Amenity</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="{{ route('homepage.manage') }}"><i class="bx bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active">Edit Featured Amenity</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="container">
        <div class="main-body">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <form action="{{ route('featured.amenity.update') }}" method="post">
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="icon_key" class="form-control" required value="{{ $amenity->icon_key }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="note" class="form-control" value="{{ $amenity->note }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
