...
<h1 style="color:#0a58ca;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:24px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">{{ config('app.name', '') }}<br/> </h1>
</div>
</div>
...
<p style="font-size: 14px; line-height: 16px; text-align: center;"><span style="font-size: 12px; line-height: 14px;"><p class="mb-0">Copyright © 2024 - <?php echo date("Y"); ?>
. All right reserved.</p></span></p>
</div>
</div>
</div>
</div>
...
<div class="bee-icon-label bee-icon-label-right"><a href="https://lucernakabgayihotel.rw/" target="_blank" title="{{ config('app.name', '') }}"></a></div>
</div>
</div>
</div>
</div>
